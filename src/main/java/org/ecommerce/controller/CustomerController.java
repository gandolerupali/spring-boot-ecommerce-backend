...
import org.ecommerce.exception.UserIdNotFoundException;
...
public class CustomerController  {
	...
	public ResponseEntity<?> addAddress(@RequestBody Address address,@PathVariable int userId) throws AddressCustomException
	{
		try
		{
	...
	public ResponseEntity<?> PlaceOrder(@RequestBody Order order) throws  OrderPlacedException
	{
		...
		{
			throw new OrderPlacedException("Problem in placing order...try after some time!!");
		}
	}
