...
public class AdminController {
            ...
            @RequestParam(name="categoryId") int  categoryId) throws IOException, ProductCustomException
    {
        ...
        product.setProductImage(productImage.getBytes());  //save product image in table as a lob type
        ...
        {
        	throw new ProductCustomException("Something is wrong in the product Details");
        }
            ...
            @RequestParam(name="categoryId") int  categoryId) throws IOException, ProductCustomException
    {
        ...
        existProduct.setProductImage(productImage.getBytes());  //save product image in table as a lob type
